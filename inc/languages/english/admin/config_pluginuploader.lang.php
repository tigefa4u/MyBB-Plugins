...
$l['pluginuploader_mods_site_unavailable'] = 'Mods Site integration is unavailable (<a href="index.php?module=config-plugins&action=pluginuploader&action2=mods_site_integration">Why?</a>)';
...
$l['pluginuploader_error_downloading_from_mods'] = 'There was an error downloading this plugin from the MyBB Mods site. This may be because the MyBB Mods site is down. To check, please try to download this plugin manually <a href="http://mods.mybb.com/download/{1}" target="_blank"><strong>here</strong></a> and import it using the form below if you are able to download it.<br /><br />If you can access the MyBB Mods site and download the plugin manually, then the issue with not being able to download it automatically lies with your server.';
...
$l['pluginuploader_error_downloading_from_mods_error_php_version'] = 'As well as this, it has been detected that your PHP version is less that PHP 5.3.4. Upgrading to PHP 5.3.4 or higher would allow you to download plugins from the MyBB Mods site.';
$l['pluginuploader_error_downloading_from_mods_contact_host'] = 'Please contact your host with this information to see if they are able to help you.';
