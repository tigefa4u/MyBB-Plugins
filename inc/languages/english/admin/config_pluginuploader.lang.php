...
$l['pluginuploader_mods_site_server_info_external_download'] = 'Using external download:';
...
$l['pluginuploader_mods_site_server_info_yes'] = 'Yes';
$l['pluginuploader_mods_site_server_info_no'] = 'No';
...
$l['pluginuploader_mods_site_server_info_what_next_external_download'] = 'Alternatively, use the External Download service, detailed below.';
$l['pluginuploader_mods_site_external_download'] = '<h2>External Download</h2>I offer the use of my server if you want to import plugins straight from the Mods Site but your server doesn\'t support it. Instead, a request will be made to my own server, with the name of the plugin you\'re trying to install, and my server will download it and send the contents back, acting as a middle-man.<br /><br />As this uses my own server, I ask for a donation of (at least) &pound;2, in return for an API key. Click the donate button below and donate at least &pound;2, making sure you include your forum URL and your email address in the message box (otherwise the key won\'t work or I won\'t be able to send it to you). When you\'ve received your API key, enter it in the box below.';
$l['pluginuploader_mods_site_external_download_api_key'] = '<strong>API Key:</strong>';
$l['pluginuploader_mods_site_external_download_api_key_rate_limit'] = 'Limited to 10 requests an hour';
$l['pluginuploader_mods_site_external_download_api_key_empty'] = 'Please enter an API key';
