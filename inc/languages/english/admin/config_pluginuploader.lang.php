...
$l['pluginuploader_plugin_readme_desc'] = "Below is the readme file that came with the plugin. It is recommended you read this to make sure you carry out any additional instructions necessary to install the plugin, and to make sure you've read any other important information.";
